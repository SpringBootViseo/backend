...
public class OrderMapperImpl implements OrderMapper {
    ...
    public List<Order> documentOrderTolistOrder(MongoCollection<Document> collection) {
        ...
        for(Document doc:collection.find()){
            ...
            User user=new User(userDocument.getString("_id"),userDocument.getString("fullname"),userDocument.getString("email"),userDocument.getString("numberPhone"),userDocument.getString("address"));
