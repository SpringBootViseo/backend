...
class PaymentServiceTest {
    ...
    void setUp(){
        ...
        payment=new Payment(id,10.0,user,null);
    }
    @AfterEach
    void tearDown(){
        id=null;
    ...
    void function5(){
        ...
        Payment payment1=new Payment(uuid,123.0,user1,null);
        Payment payment2=new Payment(uuid1,123.0,user1,null);
    ...
    void function7(){
        ...
        UUID uuid1=UUID.randomUUID();
        User user1=new User("test1","test","test","test","test",List.of(address),0,false);
        Payment payment1=new Payment(uuid,9.0,user1,null);
        Payment payment2=new Payment(uuid1,9.0,user1,null);
        List<Payment> payments=List.of(payment,payment1,payment2);
        List<Payment> payments1=List.of(payment1,payment2);
        given(paymentPort.listPayment()).willReturn(payments);
