...
class CategoryProductControllerTest {
    ...
    void setUp() {
        ...
        product = new Product(id,"test","test","test","test", List.of(new String[]{"test", "test"}),"test",0,0,0,category);
        productDTO = new ProductDTO(id,"test","test","test","test", List.of(new String[]{"test", "test"}),"test",0,0,0,categoryDTO);
        product1 = new Product(id,"test1","test1","test1","test1", List.of(new String[]{"test1", "test1"}),"test1",0,0,0,category);
        productDTO1 = new ProductDTO(id,"test1","test1","test1","test1", List.of(new String[]{"test1", "test1"}),"test",0,0,0,categoryDTO);
    ...
    void shouldReturnCategoryProductWhenlistCategoryProductsWillReturnListOfCategoriesWithTheirProducts(){
        ...
        Product product2 = new Product(id2,"test2","test2","test2","test2", List.of(new String[]{"test2", "test2"}),"test2",0,0,0,category1);
        product1.setId(id1);
        Product product3 = new Product(id3,"test3","test3","test3","test3", List.of(new String[]{"test3", "test3"}),"test3",0,0,0,category1);
        ...
        ProductDTO productDTO2 = new ProductDTO(id2,"test2","test2","test2","test2", List.of(new String[]{"test2", "test2"}),"test2",0,0,0,categoryDTO1);
        productDTO1.setId(id1);
        ProductDTO productDTO3 = new ProductDTO(id3,"test3","test3","test3","test3", List.of(new String[]{"test3", "test3"}),"test3",0,0,0,categoryDTO1);
