...
class ProductControllerTest {
    ...
    void shouldReturnListofProductsWhenListProducts(){
        ...
        Product product1=new Product(id1,"test1","test1","test1","test1", 20,List.of(new String[]{"test1", "test1"}),"test1",0,0,0,category);
        ProductDTO productdto1=new ProductDTO(id1,"test1","test1","test1","test1", 20,List.of(new String[]{"test1", "test1"}),"test1",0,0,0,categoryDTO);
    ...
    void shouldUpdateProductWhenUpdateProductWithValidProduct(){
        ...
        ProductDTO productDTO1=new ProductDTO(id,"test1","test1","test1","test1", 20,List.of(new String[]{"test1", "test1"}),"test1",0,0,0,categoryDTO);
